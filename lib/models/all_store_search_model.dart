...
//
//     final searchAllShopeModel = searchAllShopeModelFromJson(jsonString);

// ignore_for_file: prefer_if_null_operators, unnecessary_null_comparison

import 'dart:convert';

List<SearchAllShopeModel> searchAllShopeModelFromJson(String str) =>
    List<SearchAllShopeModel>.from(
        json.decode(str).map((x) => SearchAllShopeModel.fromJson(x)));

String searchAllShopeModelToJson(List<SearchAllShopeModel> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class SearchAllShopeModel {
  SearchAllShopeModel({
    this.id,
    this.products,
    this.store,
  ...
  factory SearchAllShopeModel.fromJson(Map<String, dynamic> json) =>
      SearchAllShopeModel(
