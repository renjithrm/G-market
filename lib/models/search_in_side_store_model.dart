...
//
//     final searchInSideShopeModel = searchInSideShopeModelFromJson(jsonString);

// ignore_for_file: unnecessary_null_comparison, prefer_if_null_operators

import 'dart:convert';

List<SearchInSideShopeModel> searchInSideShopeModelFromJson(String str) =>
    List<SearchInSideShopeModel>.from(
        json.decode(str).map((x) => SearchInSideShopeModel.fromJson(x)));

String searchInSideShopeModelToJson(List<SearchInSideShopeModel> data) =>
    json.encode(List<dynamic>.from(data.map((x) => x.toJson())));

class SearchInSideShopeModel {
  SearchInSideShopeModel({
    this.id,
    this.storeid,
    this.productname,
    this.unit,
  ...
  factory SearchInSideShopeModel.fromJson(Map<String, dynamic> json) =>
      SearchInSideShopeModel(
